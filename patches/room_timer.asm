...
!OWN_COUNTER_SET_16 = $F22C
!OWN_COUNTER_TOGGLED = $7FF22E
!OWN_COUNTER_TOGGLED_16 = $F22E
...
start_practice_stuff:
  ...
  JMP .normal  
  .init
    STZ !MAP_FRAME_COUNT_16
	STZ !OWN_COUNTER_SET_16
	STZ !OWN_COUNTER_TOGGLED_16
    LDA #$0001
	STA !INIT
  .normal
  LDA !MAP_ID
  ...
  LDA !MAP_ID
  STA !PREVIOUS_MAP_ID
  LDA !MAP_FRAME_COUNT : INC A : STA !MAP_FRAME_COUNT
