...
!DAMAGE_SOURCE_DETAILS = $008b ; contains $0000 if physical damage was dealt and $ (see DAMAGE_SOURCE_DETAILS, ALCHEMY_TYPE_PROJECTILE and ALCHEMY_TYPE_ANIMATION)
